 ...
 * Generated at: 2025-06-05 06:38:46 UTC
...
public final class LoginForm_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final jakarta.servlet.http.HttpServletRequest request, final jakarta.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("</head>\r\n");
      out.write("<body>\r\n");
      out.write("	<!-- 공통 링크(스타일, 메뉴 등) 포함. 보통 head 안에 써도 되고, 여긴 body에 있음 -->\r\n");
      out.write("	");
      ...
      out.write("		<!-- \r\n");
      out.write("			request 영역에 LoginErrMsg라는 속성이 있다면 에러 메시지를 출력,\r\n");
      out.write("			없으면 빈 문자열 출력. \r\n");
      out.write("			→ forward 방식으로 이동한 경우에만 request 값이 유지됨\r\n");
      out.write("		-->\r\n");
      out.write("		");
	...
	if(session.getAttribute("UserId") == null){ 
      ...
      out.write("\r\n");
      out.write("		<script>\r\n");
      out.write("		// ▶ form 제출 전에 입력값이 비었는지 검사하는 함수\r\n");
      out.write("		function validateForm(form){\r\n");
      out.write("			// 아이디가 입력되지 않은 경우\r\n");
      out.write("			if(!form.user_id.value){\r\n");
      out.write("				alert(\"아이디를 입력하세요.\");\r\n");
      out.write("				// false를 반환하면 form 제출이 중단됨 (LoginProcess.jsp로 이동 안 함)\r\n");
      out.write("				return false;\r\n");
      out.write("			}\r\n");
      out.write("			// 비밀번호가 입력되지 않은 경우\r\n");
      ...
      out.write("\r\n");
      out.write("		<!-- \r\n");
      out.write("			onsubmit 이벤트에서 validateForm 함수를 실행함.\r\n");
      out.write("			→ 이 함수에서 false를 반환하면 폼 제출이 되지 않음 (서버로 전송 중지됨)\r\n");
      out.write("		-->\r\n");
      ...
      out.write("\r\n");
      out.write("		<!-- \r\n");
      out.write("			세션에 UserId가 존재한다면 로그인 상태이므로,\r\n");
      out.write("			폼 대신 로그인된 사용자 이름과 로그아웃 링크를 보여줌\r\n");
      out.write("		-->\r\n");
      out.write("		");
