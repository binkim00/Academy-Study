		...
		<div class="bodytext_area box_inner">
			...
			<form action="JoinProcess.jsp" method="post" class="appForm">
					    ...
					    <ul class="app_list">
					      <li class="clear">
					        ...
					        <div class="app_content email_area">
					          ...
					          <div class="select_common">
					            <select name="email3" title="이메일 제공업체 목록">
					      ...
					      <li class="clear">
					        ...
					        <div class="app_content">
					          <input type="text" name="name" class="w100p" id="name_lbl" placeholder="이름을 입력해주세요" />
					        </div>
					      </li>
					      <li class="clear">
					        <label for="pwd_lbl" class="tit_lbl pilsoo_item">비밀번호</label>
					        <div class="app_content">
					          <input type="password" name="password" class="w100p" id="pwd_lbl" placeholder="비밀번호를 입력해주세요" />
					        </div>
					      </li>
					      <li class="clear">
					      ...
					      <li class="clear">
					        ...
					        <div class="app_content">
					          <input type="tel" name="phone" class="w100p" id="phone_lbl" placeholder="휴대폰”-”없이 숫자만 입력하세요" />
					        </div>
					      </li>
					      <li class="clear">
					      ...
					      <li class="clear">
					        ...
					        <div class="app_content checkbox_area">
					          <input type="checkbox" class="css-checkbox" id="agree_lbl" name="agree" value="1" /><label for="agree_lbl">동의함</label>
					        </div>
					      </li>
					      <li class="clear">
					...
					전화 상담 희망시 기재 부탁드립니다."></textarea>
					    ...
					    <p class="btn_line">
					      <input type="submit" value="등록" class="btn_baseColor" />
					    </p>
					  </fieldset>
			</form>
