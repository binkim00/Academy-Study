...
<html lang="ko">
<head>
    <title>${board.title} | 공지사항 | 투어리스트인투어</title>
    ...
    <div id="container">
        ...
        <div class="bodytext_area box_inner">
            <ul class="bbsview_list">
                ...
                <li class="bbs_hit">작성일 :
                    <span><fmt:formatDate value="${board.postdate}" pattern="yyyy-MM-dd" /></span>
                </li>
                <li class="bbs_date">조회수 : <span>${board.visitcount}</span></li>
            ...
            <p class="btn_line txt_right">
                <c:if test="${sessionScope.loginUser != null and sessionScope.loginUser.id eq board.id}">
            ...
            <ul class="near_list mt20">
                <li><h4 class="prev">다음글</h4>
                    <a href="javascript:;">추석 연휴 티켓/투어 배송 및 직접 수령 안내</a>
                </li>
                <li><h4 class="next">이전글</h4>
                    <a href="javascript:;">이번 여름 휴가 제주 갈까? 미션 투어 (여행경비 50만원 지원)</a>
                </li>
            </ul>
        </div>
        <!-- //bodytext_area -->
